...
/************************************************************************************
 ...
 Date: 19990407HK
 Purpose: given a pocket and a flop, find the best hand and return it in the hand_out
*************************************************************************************/
...
/**********************************************************************************
 ...
 Date: HK1999/05/04
 Purpose: let an outsider evalute a poker hand
***********************************************************************************/
...
/**********************************************************************************
 ...
 Date: 19990407HK
 Purpose: at the lowest level, we want to evaluate and grade a proper 5-card hand
 20000208HK: added flag for ignoring for low (T for high, F for low)
***********************************************************************************/
...
/**********************************************************************************
 ...
 Date: 19990407HK
 Purpose: given a test hand, we just want to evaluate what sort of hand it is
 20000208HK: added flag for ignoring for low (T for high, F for low)
***********************************************************************************/
...
/**********************************************************************************
 ...
 Date: 19990407HK
 Purpose: given a test hand, evaluate its specific values for comparison to others
 20000301HK: added flag for high/low (T for high, F for low)
***********************************************************************************/
void Poker::SetTestHandValue(Hand *test_hand, int high_hand_flag)
{
	...
	switch (G_VALUE(0)) {	// VALUE(0) holds the hand type -- we'll start adding at 1 onward
		case HIGHCARD :
			// 20000301HK: this is where the low-hand evaluation exception takes place
...
/**********************************************************************************
 ...
 Date: 19990407HK
 Purpose: determine which of two test hands is better (or if it's a tie)
***********************************************************************************/
WinningHand Poker::FindBetterHand(Hand hand_1, Hand hand_2)
{
	...
	for (int index = 0; index  < HAND_VALUE_SIZE; index ++) {
		if (hand_1.GetValue(index) != hand_2.GetValue(index)) {
			// 20000301HK: added exception that if there is an ACE is the last slot,
...
/**********************************************************************************
 ...
 Date: HK1999/05/29
 Purpose: return which card is ranked higher -- CARD_1 or CARD_2 or TIE
***********************************************************************************/
...
/**********************************************************************************
 ...
 Date: 19990611HK
 Purpose: given 2 5-card hands, describe hand1 (better hand) as it relates to hand2
...
//	if (GH_VALUE1(0) != GH_VALUE2(0)) {	// they're entirely different, simple description is ok
	...
	case HIGHCARD :
		// 20000301HK: low hand description
		// extern char cRanks[];	// "23456789TJQKA"
...
/**********************************************************************************
 ...
 Date: HK1999/05/21
 Purpose: given a proper omaha pocket and flop, find the best hand
***********************************************************************************/
...
/**********************************************************************************
 ...
 Date: 19990410HK
 Purpose: find the best 5-card hand from a 7-card hand
***********************************************************************************/
...
/**********************************************************************************
 ...
 Date: 19990504HK
 Purpose: find the best 5-card hand from a 6-card hand
***********************************************************************************/
...
/**********************************************************************************
 ...
 Date: HK00/03/01
 Purpose: return T/F if a low hand qualifies as high-card 8 or better
***********************************************************************************/
