...
#if 0	//20010227MB: for testing

  #define DEADLOCK_WARNING_TIME_MS		(2)	// time in ms before printing a deadlock warning
...

{
	...
	if (stack_size) {
		...
		//19990812MB: Under linux pthreads on Intel, I believe stacks

		// default to 2MB and are allocated as needed.  I understand
...

{
  ...
  #if 1	//20000608MB: crashes eventually under Win32... no idea why.

	// First, guess it's the same as last time.	
...

{
  ...
  #if 0	//20010207MB: disabled because it seems to make things WORSE!

	//20010207MB: if there is someone else already waiting for this

	// critical section, check to see if we should sleep rather than
...

{
  ...
  #if INCLUDE_FUNCTION_TIMING	//20000604MB
