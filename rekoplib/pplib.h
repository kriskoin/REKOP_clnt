/**************************************************************************************
 ...
 pplib.h -- universal defines for e-Media Poker, including headers for pplib.lib
...
#define DATABASE_NAME	  "TropicanaPoker"			// used for the name of the database
...
// 20000713HK: the enum was done like this to be backwards-compatible with the old real_money flag
