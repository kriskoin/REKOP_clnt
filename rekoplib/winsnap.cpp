...
static void BuildSnapList(SnapVars *sv)
{
		...
		//19990225MB: check the desktop dimensions and guess whether we're
		// dealing with multiple monitors or not.
...
//			dprintf("Number of monitors horizontally = %.2f (%d), vertically = %.2f (%d)", r, horz_monitor_count, 1.0/r, vert_monitor_count);
		...
		//19990225MB: loop through all open windows (EnumWindows())
		// and add their lines if they are nearby in the other dimension.
